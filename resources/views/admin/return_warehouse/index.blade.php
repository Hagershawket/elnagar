...
@section('title',' مرتجعات مستودع')
@section('css')
@endsection
@section('header_title',' مرتجعات مستودع')
@section('content')
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="dainfo">
        <h3>مرتجعات مستودع</h3>
      </div>
    </div>
      <div class="col-md-12 col-sm-6 col-lg-6">
        <div class="butonmodr text-left">
          <a href="" data-toggle="modal" data-target="#addModal" class="action quickview btn btn-info"><i class="fa fa-plus"></i>اضافة مرتجع </a>
        </div>
      </div>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="{{route('selectPurchaseWarehouse')}}">
        @csrf
