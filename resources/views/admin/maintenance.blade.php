...
<html lang="en">
  <head>
    ...
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="{{asset('public/admin/assets/css/bootstrap.min.css')}}">
    <!-- App css-->
  ...
  <body>
        ...
        <div class="error-wrapper maintenance-bg">
          <div class="container">
            ...
            <div class="maintenance-heading">
              <h2 class="headline">تحت التنفيذ</h2>
            </div>
            <h4 class="sub-content">موقعنا قيد الصيانة حاليًا سنعود قريبًا<br>شكرًا على الصبر</h4>
            <div><a class="btn btn-primary btn-lg text-light" href="{{route('home')}}">العودة الي الرئيسية</a></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
    <script src="{{asset('public/admin/assets/js/script2.js')}}"></script>
    <!-- login js-->
    <!-- Plugin used-->
  </body>
</html>