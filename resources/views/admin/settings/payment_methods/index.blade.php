...
@endsection
@section('header_title','طرق الدفع')
@section('content')

    <div class="row">
      <div class="col-md-12 col-sm-6 col-lg-6">
        <div class="dainfo">
          <h3>طرق التحصيل والصرف</h3>
        </div>
      </div>
      <div class="col-md-12 col-sm-6 col-lg-6">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="conhhh text-center">
                        <a href="#"  style="color: white;" class="action quickview btn btn-success" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#editModal{{$method->id}}"><i class="far fa-edit"></i> تعديل </a>
  ...
  <div class="contentmoder">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="heading-title">اضافة طريقه دفع </h4>
