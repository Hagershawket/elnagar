                    ...
                    <table id="example" class="display nowrap" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">سعر التحويل</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($currencies as $currency)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $currency->value }}</td>
                                    <td>
                                        <div class="conhhh text-center">
                                            <a href="#" style="color: white;" class="action quickview btn btn-success"
                                                ...
                                                data-bs-target="#editModal{{ $currency->id }}"><i
                                                    class="far fa-edit"></i> تعديل </a>
                                            <a href="#" style="color: white;" type="submit"
                                                class="btn btn-sm btn-danger p-2"><i class="fas fa-trash-alt"></i> حذف</a>
                                        </div>
                                    </td>
                                </tr>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="heading-title">تعديل العملة</h4>
    ...
    <div class="contentmoder">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="heading-title">اضافة عملة </h4>
                                    ...
                                    <div class="bd-examplepl">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12 labelform">
                                                ...
                                                <div class="controlsopop">
                                                    <i class="far fa-envelope"></i>
                                                    <input type="text" name="value" placeholder="اضافة"
                                                        class="form-control">
                                                </div>
                                            </div>
