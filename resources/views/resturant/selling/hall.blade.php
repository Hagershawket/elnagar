...
@endsection
@section('header_title', 'صاله')
@section('content')
<div class="dainfo">
    <h3 style="font-size: 30px; color:blue">صاله </h3>
</div>
<form method="post" action="{{ route('makeOrderhall') }}">
    @csrf
    <div class="row">
        <input type="hidden" name="order" value="0">
        <div class="col-md-3 col-12 form-group">
            <label> ترابيزه <span style="color:#040202;">*</span></label>
            <div class="inputcode">
                <div class="iconantimat"> <i class="fas fa-eraser"></i></div>
                <input type="text" class="form-control" name="table_num">
            </div>
        </div>
        ...
        <div class="col-md-3 col-12 form-group ">
            <label> خدمه <span style="color:#040202;">*</span></label>
            <div class="inputcode">
                <div class="iconantimat"> <i class="fas fa-eraser"></i></div>
...
<script>
    function sum() {
        ...
        $('input[name="discount"]').keyup(function() {
            ...
            service = parseFloat($('input[name="service"]').val());
