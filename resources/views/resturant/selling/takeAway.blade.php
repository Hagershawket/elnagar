...
@section('title', 'تيك اواى')
@section('css')

@endsection
@section('header_title', 'تيك اواى')
@section('content')
        <div class="dainfo">
            <h3 style="font-size: 30px; color:blue">تيك اواي</h3>
        </div>
        <form method="post" action="{{ route('makeOrdertakaway') }}">
            @csrf
            <div class="row">
                                    ...
                                    <tbody  class="orderItem">
                                        <tr>
                                            <td class = "text-center col-4">
                                                <div class="inputcode">
                                                    <div class="iconantimat"><i class="fas fa-eraser"></i></div>
                                                    <select class="form-control product" name="product_id[]" id="product">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <script>
        $(document).ready(function() {
            $("#add").click(function() {
                ...
                var html =' <tr>'
                    html +=' <td class = "text-center col-4"><div class="inputcode"><div class="iconantimat"><i class="fas fa-eraser"></i></div><select class="form-control" name="product_id[]" id="product"><option disabled selected>اخترالصنف </option> @foreach ($products as $product)<option value="{{ $product->id }}">{{ $product->name }} </option> @endforeach</select></div></td>';
                    html +='  <td class = "text-center"><input type="text" name="quantity[]" class="form-control quantity" required></td>';
                    html +='  <td class = "text-center"><input type="text" name="netQty[]" class="form-control" required></td>';
                    html +='  <td class = "text-center"><input type="text" name="wieght[]" class="form-control" required></td>';
                    html +='  <td class = "text-center"><input type="text" name="price[]" class="form-control price" required></td>';
                    html+='  <td class = "text-center"><input type="text" name="total[]" class="form-control total" required></td>';
    ...
    <script>
       ...
       $('input[name="discount"]').keyup(function(){
        ...
        $('input[name="total_price"]').val(sum - discount);
       });
    }
